...
struct Tutorial: UIViewControllerRepresentable {
    func makeUIViewController(context: Context) -> WhatsNewViewController {
        ...
        let whatsNew = WhatsNew(title: "Welcome to VacciMap", items: [
            ...
            WhatsNew.Item(title: "Vaccines Available", subtitle: "Look for a bright green pin", image: UIImage(systemName: "hand.point.right")),
            WhatsNew.Item(title: "Testing Available", subtitle: "Look for a dark green pin", image: UIImage(systemName: "hand.point.right")),
            WhatsNew.Item(title: "Out of Doses", subtitle: "Sites that have run out of vaccine doses will appear gray", image: UIImage(systemName: "hand.point.right")),
            WhatsNew.Item(title: "Out of Tests", subtitle: "Sites that have run out of tests will appear dark gray", image: UIImage(systemName: "hand.point.right")),
        ])
